    ...
    public void adjustVolume(char ch, int value) {
        try {
            ...
            if (ch == '-')
             ...
             System.out.println("Volumne_MAX. That's TOO LOUD!");
//             ch = '-';
//             decreaseVolume(1);
        } catch (VolumeUnderFlowException e){
             System.out.println("Volumne_MIN");
//             ch = '+';
//             increaseVolume(1);
        }        
   ...
   public void increaseVolume(int increment) throws VolumeOverFlowException {
    ...
    public static void main(String[] args) throws Exception { 
        try {            
            ...
            mp1.adjustVolume('+', 60);    // throw VolumeOverFlowException  // WHERE IS  adjustVolume????
            ...
            mp1.turnOff();  
//        } catch (VolumeUnderFlowException e) {
//            System.out.println("Volumne is underflow.");
//        } catch (VolumeOverFlowException e) {
//            System.out.println("Volumne is overflow.");
