				    ...
				    case  ":PENDING_REQUESTS":
				    	...
				    	if (numcomma != 3) { 
				    		...
				    		if (task.equals("*") && reqfrom.equals("*") && reqto.equals("*")) {
				    			if (requestMsgs.size() == 0) out.print("[ ]");  //didn't print out "[ ]"???
				    		...
				    		else if (task.equals("#") && locMatch(reqfrom) && reqto.equals("*")) {
				    		...
				    		else if (task.equals("#") &&  reqfrom.equals("*") && locMatch(reqto)) {
				    			...
				    			out.println("RESPONSE: # of pending requests = " + requestMsgs.size());    
				    		//      total  number of pending  requests
				    		else out.println("ERROR: invalid command");
				    		//  Make sure this will be printed out!!!
				    		client.close();
				    		break;
				    	}
				    ...
				    default :	
				    	if  (input.charAt(0) == ':') {
							...
							//	System.out.println(reqMsgname + " " + reqMsgfrom +"-->" + reqMsgto);
						    	if (locMatch(reqMsgfrom) && !(reqMsgfrom.equals(reqMsgto)) 
						    			&& (locMatch(reqMsgto) || reqMsgto.equals("*"))) {
									...
									//     System.out.println( "output is added into pending printWriter");
								    	...
								    	for (int i = 0; i < requestMsgs.size(); i++) {
								    		...
								    		if (from.equals(reqMsgfrom) && ( to.equals(reqMsgto) 
								    				|| reqMsgto.equals("*") || to.equals("*"))) {
